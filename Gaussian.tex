...
\\
 \textbf{Solution:}
 \\
 This experiment has a Binomial Distribution with n = 12 and p = 0.1.
 ...
 \begin{align}
    ...
    \sigma&= 1.04
    \end{align}
 \\z-score for the event E can be calculated as
\begin{align}
...
\\The probability of an event having z-score greater than 7.5 is very low and is equal to $4.338751580235112 \times 10^{-13}$
\\Therefore, $\pr{E} = 4.338751580235112 \times 10^{-13}$
\begin{figure}
\centering
\includegraphics[width=\columnwidth]{./figs/PMF_PDF_plot.png}
\end{figure}
\end {document}